  ...
  render() {
    return (
      <div className="container Example">
        ...
        <div>
          <label htmlFor="mottoChanger">New motto: </label>
          <input 
            id="mottoChanger"
            type="text"
            value={this.state.incomingMotto}
            onChange={(e) => this.setState({incomingMotto: e.target.value})} 
          />
          <button
            onClick={() => this.setState({motto: this.state.incomingMotto, incomingMotto: ''})}
          >
            Change Motto
          </button>
          <button 
            onClick={() => this.setState({motto: window.cs142models.exampleModel().motto, incomingMotto: ''})}
          >
              Reset Motto
          </button>
        </div>
...
<input type="text" value={this.state.inputValue} onChange={this.handleInputChangeBound} />`
            }
          </code>
        </pre>
        <p>
          ...
          out blank) and calls the function this.handleInputChangedBound every time the
        ...
        <div className="cs142-example-output">
          ...
          <input id="inId" type="text" value={this.state.inputValue} onChange={this.handleInputChangeBound} />
        </div>
        <p>
          The handleInputChangeBound function updates this.state.inputValue with the
          ...
          call <code>this.handleInputChange</code> since it is a method function of an object
          that is not available to the DOM. To handle this we create a new
          function <code>this.handleInputChangeBound</code> that can call the method and use it here.
        </p>
        <p>
